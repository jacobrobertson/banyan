...
import com.robestone.banyan.json.SearchIndexBuilder.CandidateEntry;
import com.robestone.banyan.json.SearchIndexBuilder.CandidateName;
import com.robestone.banyan.json.SearchIndexBuilder.KeyEntry;
...
public class SearchIndexBuilderTest extends TestCase {
	...
	private CandidateEntry testCandidateEntry(String latinName, String commonName, List<CandidateEntry> candidates, String key, int expectedScore) {
		TaxonNode entry = new TaxonNode();
		entry.setLatinName(latinName);
		entry.setCommonName(commonName);
		entry.setTaxonId(Integer.valueOf(expectedScore));
		entry.setImage(new Image());
