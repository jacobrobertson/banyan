...
public class ImagesWorkerTest {
	...
	public void testDjvu() {
		ImagesWorker.ImageInfo ii = new ImagesWorker.ImageInfo(
				"Anything", "thumb/2/27/Flora_Graeca%2C_Volume_6.djvu/page153-250px-Flora_Graeca%2C_Volume_6.djvu.jpg");
		assertEquals(ii.getFileExtension(), "djvu");
