...
import com.robestone.banyan.wikipedia.WikipediaCommonNamePatternParser;
...
public class WikipediaCommonNamePatternParserTest extends TestCase {
	...
	public void testGeneral() {
		...
		doTest("Acacia mearnsii", "Black Wattle", "'''''Acacia mearnsii''''' is a fast-growing [[legume|leguminous]] tree native to [[Australia]]. Common names for it include '''Black Wattle''', '''''Ac�cia-negra''''' ([[Portuguese language|Portuguese]]), '''Australian Acacia''', '''''Australische Akazie''''' ([[German language|German]]),");
