...
public class CompleteEntry implements Entry {
	...
	public CompleteEntry(EntryProperties props) {
		this.props = props;
	}
	public CompleteEntry(Rank rank, String commonName, String latinName) {
		this();
		setRank(rank);
	...
	public List<? extends Entry> getChildren() {
		return children;
	}
	public List<CompleteEntry> getCompleteEntryChildren() {
		return children;
	}
	public void setChildren(List<CompleteEntry> children) {
	...
	public CompleteEntry getCompleteEntryParent() {
		return parent;
	}
	public CompleteEntry getParent() {
		return parent;
	}
	public void setParent(CompleteEntry parent) {
		this.parent = parent;
	}
